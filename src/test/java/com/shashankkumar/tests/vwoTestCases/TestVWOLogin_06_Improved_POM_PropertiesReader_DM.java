...
public class TestVWOLogin_06_Improved_POM_PropertiesReader_DM extends CommonToAllTest {
// for log
private static final Logger logger = LogManager.getLogger(TestVWOLogin_06_Improved_POM_PropertiesReader_DM.class);
    @Owner("Shashank")
